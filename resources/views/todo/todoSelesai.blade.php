...
<div class="container py-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb bg-light px-3 py-2 rounded">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tugas Selesai</li>
        </ol>
    </nav>

    {{-- Judul --}}
    <div class="text-center mb-4">
        <h4 class="fw-bold text-success">✅ Tugas Diselesaikan</h4>
    </div>
            ...
            <table class="table table-bordered table-hover table-striped align-middle bg-white shadow-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-success fw-bold text-center">{{ $ts->keterangan }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
    ...
    @else
        <div class="alert alert-secondary text-center">
            📭 Tidak ditemukan data tugas yang diselesaikan.
        </div>
    @endif
